...
namespace NLEditor
{
    public static class C // for Constants
    {
        ...
        public static string AppPathEditorSettings => AppPathSettings + "NLEditorSettings.ini";
        public static string AppPathHotkeys => AppPathSettings + "NLEditorHotkeys.ini";
        public static string AppPathCustomSkillsets => AppPathSettings + "NLEditorCustomSkillsets.ini";
