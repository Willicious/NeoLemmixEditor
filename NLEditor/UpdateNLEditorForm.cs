    ...
    partial class NLEditForm
    {
        ...
        private void UpdateBackgroundImage()
        {
            if (CurLevel.ThemeStyle == null)
                return;
            Color backColor = CurLevel.ThemeStyle?.GetColor(C.StyleColor.BACKGROUND) ?? C.NLColors[C.NLColor.BackDefault];
        ...
        private void UpdateFlagsForPieceActions()
        {
            ...
            checkNoOverwrite.CheckedChanged -= checkNoOv_CheckedChanged;
            ...
            // Set check-mark correctly, without firing the CheckedChanged event
            checkErase.CheckedChanged -= checkErase_CheckedChanged;
            ...
            // Set check-mark correctly, without firing the CheckedChanged event
            checkAllowOneWay.CheckedChanged -= checkOneWay_CheckedChanged;
            ...
            // Set check-mark correctly, without firing the CheckedChanged event
            checkOnlyOnTerrain.CheckedChanged -= checkOnlyOnTerrain_CheckedChanged;
        ...
        private void PositionPieceControls()
        {
            ...
            int controlsTop = checkCloner.Bottom + 12;
