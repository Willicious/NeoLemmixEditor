    ...
    class Renderer : IDisposable
    {
        ...
        private void CreateLevelImageFromLayers(string dragNewPieceKey = null)
        {
            ...
            else
            {
                ...
                baseLevelImage = new Bitmap(level.Width, level.Height);
                baseLevelImage.Clear(level.ThemeStyle?.GetColor(C.StyleColor.BACKGROUND) ?? C.NLColors[C.NLColor.BackDefault]);
            }
        ...
        public void CreateBackgroundLayer()
        {
            ...
            layerImages[C.Layer.Background].Clear(level.ThemeStyle?.GetColor(C.StyleColor.BACKGROUND) ?? C.NLColors[C.NLColor.BackDefault]);
        ...
        public void AddHatchArrow(ref Bitmap levelBmp)
        {
            ...
            for (int hatchIndex = 0; hatchIndex < hatches.Count; hatchIndex++)
            {
                ...
                levelBmp.WriteText(directionString, screenTextCenterPos, C.NLColors[C.NLColor.Text], fontSize);
            }
        }
        ...
        private void AddSelectedRectangles(ref Bitmap levelBmp)
        {
            ...
            var rulerRects = selectedGadgets
                ...
                .ToList();
            levelBmp.DrawOnRectangles(rulerRects, C.NLColors[C.NLColor.SelRectRulers]);
            ...
            var gadgetRects = selectedGadgets
                ...
                .Select(gad => GetPicRectFromLevelRect(gad.ImageRectangle))
                .ToList();
            levelBmp.DrawOnRectangles(gadgetRects, C.NLColors[C.NLColor.SelRectGadget]);
            ...
            var steelRects = selectedTerrain
                ...
                .ToList();
            levelBmp.DrawOnRectangles(steelRects, C.NLColors[C.NLColor.SelRectSteel]);
